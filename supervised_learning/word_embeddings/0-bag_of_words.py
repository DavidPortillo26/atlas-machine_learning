...
def bag_of_words(sentences, vocab=None):
    ...
    parameters:
        ...
        vocab [list]:
            ...
            if None, all words within sentences should be usedfrom sklearn.feature_extraction.text import CountVectorizer
...
def bag_of_words(sentences, vocab=None):
    ...
    features = vectorizer.get_feature_names_out()  # Updated method
